...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig2_fare_components.eps}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/fig3_earnings_distribution.eps}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/fig1_fare_distance_regression.eps}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/fig4_temporal_patterns.eps}
